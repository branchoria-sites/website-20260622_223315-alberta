...
show_ads: true
description: A Nunavut pilot sighting can become an official aviation record through air traffic reporting, NAV CANADA and Transport Canada processing.
hero_summary: A Nunavut pilot sighting can become an official aviation record through air traffic reporting, NAV CANADA and Transport Canada processing.
layout: default
...
next_link:
  ...
  heading_title: Does NORAD involvement prove anything unusual?
header:
  og_image: /assets/images/Nunavut_1ecc65_cadors_ufo_meaning_110785_pilot_sighting_repor_39d036-Illustration-1-social.jpg
  preview_image: /assets/images/Nunavut_1ecc65_cadors_ufo_meaning_110785_pilot_sighting_repor_39d036-Illustration-1.webp
image: /assets/images/Nunavut_1ecc65_cadors_ufo_meaning_110785_pilot_sighting_repor_39d036-Illustration-1-social.jpg
---
...
* An unexpected light at cruising altitude.
* An apparent object crossing a flight path.
* A bright object whose position or movement cannot immediately be explained.
* A possible balloon, drone, meteor or aircraft that cannot be positively identified at the time.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/-j6HAGD8BR8" title="Thrilling Pilotviews into Nunavut, Baffin Island" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=-j6HAGD8BR8" target="_blank" rel="noopener noreferrer">Thrilling Pilotviews into Nunavut, Baffin Island</a></p><p class="youtube-embed-meta">Channel: Just Planes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=-j6HAGD8BR8" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=-j6HAGD8BR8">Open on YouTube</a></p></div></div></div>


<img src="{{ "/assets/images/Nunavut_1ecc65_cadors_ufo_meaning_110785_pilot_sighting_repor_39d036-Illustration-2-dark.svg" | relative_url }}" alt="Report Chain illustration 2" data-theme-src-dark="{{ "/assets/images/Nunavut_1ecc65_cadors_ufo_meaning_110785_pilot_sighting_repor_39d036-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Nunavut_1ecc65_cadors_ufo_meaning_110785_pilot_sighting_repor_39d036-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. A pilot or controller observes or receives information about an unusual occurrence.
2. Air traffic services personnel document the event.
3. Reportable information is transmitted through established occurrence-reporting procedures.
4. The information is entered into CADORS and distributed to relevant aviation stakeholders.
5. Additional review may occur if the event raises safety, security or operational concerns. [Transport Canada+2Transport Canada](https://tc.canada.ca/en/aviation/publications/aviation-safety-letter/issue-2-2021/civil-aviation-daily-occurrence-reporting-system-cadors)

</div>

Because many northern routes cross remote regions with little ground-based observation, pilots often provide the primary evidence. A CADORS entry may therefore contain only the details available from cockpit observations and radio communications. In some cases there is no radar confirmation, photograph or physical evidence attached to the initial report. [open.canada.ca](https://open.canada.ca/data/en/dataset/a348c1d1-2392-4595-b5e2-c6a244a7e87f)

This limitation is especially relevant when readers encounter [CADORS records]({{ 'cadors-record/' | relative_url }}) describing unidentified objects over Nunavut. The database preserves the report, but the amount of information available for later analysis can vary considerably.

## The 2018 Baffin Island example

The best-known Nunavut example occurred on 24 November 2018, when pilots aboard a Nolinor Aviation Boeing 737 reported an unidentified object while approaching the Mary River mine area in northern Baffin Island. The event became publicly known because it appeared in CADORS. According to contemporary reporting, the entry suggested several possible [explanations]({{ 'explanations-f6c4b5/' | relative_url }}), including a weather balloon, meteor, rocket or other unidentified object. [Nunatsiaq News](https://nunatsiaq.com/stories/article/65674pilots_spot_possible_ufo_above_nunavuts_northern_baffin_island/)

The case illustrates the reporting chain in action. The pilots made an operational report, the information entered the aviation occurrence system, and the resulting CADORS record became accessible to journalists and researchers. The official record demonstrated that trained aviation personnel reported something unusual. It did not establish what the object actually was. [Nunatsiaq News](https://nunatsiaq.com/stories/article/65674pilots_spot_possible_ufo_above_nunavuts_northern_baffin_island/)

For students of Nunavut UFO history, this distinction is crucial. The most valuable aspect of the record is often not the mystery itself but the documented fact that a report was made through official aviation channels.

## Why official logging is not final proof

One of the most common misunderstandings about CADORS is the assumption that an official record confirms the reality or nature of an object. Transport Canada repeatedly cautions that CADORS reports contain preliminary information and should be treated as unconfirmed and subject to change. The system exists to identify potential hazards and share occurrence information quickly, not to deliver final investigative conclusions. [wwwapps.tc.gc.ca+3Transport Canada+3Transport Canada](https://tc.canada.ca/en/aviation/publications/aviation-safety-letter/issue-2-2021/civil-aviation-daily-occurrence-reporting-system-cadors)

This matters because a CADORS entry can begin with very limited information. A pilot may have only seconds to observe an object. Distance, size and speed can be difficult to judge in darkness or over featureless northern terrain. Later analysis may point towards a meteor, atmospheric phenomenon, satellite reflection, balloon or another conventional explanation. In other cases, insufficient information remains to reach any firm conclusion. [Transport Canada](https://tc.canada.ca/en/binder/4-high-altitude-object-incidents)

As a result, a CADORS UFO report should be read as evidence that:

* A witness reported an unusual aerial observation.
* The report entered an official aviation-safety process.
* Authorities considered the occurrence worth recording.

It should not automatically be read as evidence that an exotic craft, unknown technology or extraordinary phenomenon was confirmed. [Transport Canada+2Transport Canada](https://tc.canada.ca/en/aviation/publications/aviation-safety-letter/issue-2-2021/civil-aviation-daily-occurrence-reporting-system-cadors)

## What CADORS records contribute to Nunavut UFO history

Within Nunavut's UFO record, CADORS entries are valuable because they create a documented trail that can be checked against dates, locations, flight paths and later explanations. They provide a level of transparency that is often absent from anecdotal sightings. At the same time, they remain only the first stage of documentation. [open.canada.ca](https://open.canada.ca/data/en/dataset/a348c1d1-2392-4595-b5e2-c6a244a7e87f)
