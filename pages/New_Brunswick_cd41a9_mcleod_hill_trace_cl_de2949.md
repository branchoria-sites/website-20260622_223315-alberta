...
- New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_index
...
show_ads: true
description: The McLeod Hill case is intriguing because it includes alleged ground marks, but its public record remains too thin for firm conclusions.
hero_summary: The McLeod Hill case is intriguing because it includes alleged ground marks, but its public record remains too thin for firm conclusions.
layout: default
permalink: /mc-leod-hill/
sidebar_expanded_urls:
- /what-really-happened-in-new-brunswick/
nav_short_title: Mc Leod Hill
title: Did Something Leave Marks at Mc Leod Hill?
title_full: Did Something Leave Marks at Mc Leod Hill?
display_title_short: Mc Leod Hill
display_title: Mc Leod Hill
heading_title: Did Something Leave Marks at Mc Leod Hill?
page_heading_title: Did Something Leave Marks at Mc Leod Hill?
source_count: 65
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Did West Bathurst Reach Scientists?
header:
  og_image: /assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949-overview-social.jpg
  preview_image: /assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949-overview.webp
image: /assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949-overview-social.jpg
---
...
That tension is why McLeod Hill matters. It is not a “proved landing” case. It is better understood as a local report that sits between folklore, witness memory and UFO cataloguing, showing how a striking provincial story can persist even when the documentary record remains too limited for confident conclusions.
...
* precise measurements of every hole or depression;
* photographs taken before the site was disturbed;
* soil, vegetation or residue samples with a clear chain of custody;
* weather records and field-use information;
* witness statements taken close to the event;
* checks for farm equipment, animals, posts, drainage, lightning, hoaxing or pre-existing marks;
* records from police, aviation, airport or federal reporting channels.

</div>

None of those items is publicly attached to McLeod Hill in the accessible sources. That does not prove the witnesses were wrong. It does mean the marks cannot now be assessed as a reliable physical effect of an unknown object.
...
The most careful conclusion is that McLeod Hill is a weakly documented but locally significant UFO trace claim. It has three things going for it: a specific New Brunswick location, a date in at least one UFO trace catalogue, and a later local account naming the farm family context and describing [field marks]({{ 'field-marks/' | relative_url }}). It also has three major weaknesses: the lack of contemporary press coverage in the known retelling, the lack of public official documentation, and the lack of physical evidence preserved in a form that can be checked.

That puts it below better-documented Canadian physical-trace cases in evidential strength. It should not be presented as proof that an unknown craft landed near Fredericton. Nor should it be dismissed as worthless folklore. Its value is more modest: it shows how rural UFO reports in New Brunswick could combine ordinary farm landscapes, family witnesses, local rumour, later oral history and national UFO catalogues into a case that remains interesting precisely because the evidence stops short of resolution.

Within New Brunswick’s UFO history, McLeod Hill is useful as a cautionary example. A ground-mark claim naturally feels more concrete than a light in the sky, but “something left marks” is not the same as “the marks were caused by the reported object”. The missing step is investigation. Without measurements, photographs, samples or contemporary records, the circular holes remain an allegation attached to a sighting, not a tested physical trace.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/Y-F80OfFY2w" title="Stanton T. Friedman - Canadian Government and UFOs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=Y-F80OfFY2w" target="_blank" rel="noopener noreferrer">Stanton T. Friedman - Canadian Government and UFOs</a></p><p class="youtube-embed-meta">Channel: Paul Kimball</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=Y-F80OfFY2w" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=Y-F80OfFY2w">Open on YouTube</a></p></div></div></div>
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Did Something Leave Marks at McLeod Hill?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers UFO reports, close encounters, and physical trace claims within a structured investigative framework.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explores how unusual reports persist through folklore, memory, and witness testimony.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Examines documented UFO reports and evidentiary standards, matching the article&#x27;s focus on limited evidence.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context on how UFO reports are documented, assessed, and often left unresolved.</p>
        <div class="fr-book-actions">
