...
show_ads: true
description: A single bright meteor over Alberta can generate hundreds of sincere UFO reports before the sky event is identified.
hero_summary: A single bright meteor over Alberta can generate hundreds of sincere UFO reports before the sky event is identified.
layout: default
permalink: /fireballs/
...
title: When one fireball becomes a UFO wave
title_full: When one fireball becomes a UFO wave
display_title_short: Fireballs
display_title: Fireballs
heading_title: When one fireball becomes a UFO wave
page_heading_title: When one fireball becomes a UFO wave
source_count: 20
infographic_count: 3
planned_sections:
- The 2021 morning fireball north of Edmonton
- Why meteors look lower and stranger than they are
- How cameras and witness maps can turn panic into identification
...
next_link:
  ...
  heading_title: What Alberta UFO numbers can and cannot prove
header:
  og_image: /assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-1-social.jpg
  preview_image: /assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-1.webp
image: /assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-1-social.jpg
---
...
Many UFO reports generated by fireballs arise from well-known limits in human perception rather than careless observation. In fact, dramatic fireballs frequently fool experienced witnesses.
...
A fireball creates a distinctive reporting pattern that differs from many other Alberta UFO cases.

Typically, several things happen in quick succession:


<img src="{{ "/assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-2-dark.svg" | relative_url }}" alt="Fireballs illustration 2" data-theme-src-dark="{{ "/assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. A bright object crosses the sky for only a few seconds.
2. Witnesses record videos or contact media outlets and authorities.
3. Social media spreads reports faster than formal identification can occur.
4. Different descriptions emerge because witnesses observed the event from different locations.
5. UFO reporting services receive numerous submissions that initially appear unrelated.
6. Astronomers, meteor networks or universities compare the evidence and identify a common source.
...
The result is one of the most valuable lessons in Alberta UFO history: more witnesses do not automatically mean a stronger UFO case. Sometimes they mean the opposite. A large number of independent observations can supply enough information to identify the event conclusively.


<img src="{{ "/assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-3-dark.svg" | relative_url }}" alt="Fireballs illustration 3" data-theme-src-dark="{{ "/assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alberta_1dc61b_alberta_sighting_wav_d77d81_alberta_fireball_wav_3610a7-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What fireball waves tell us about Alberta UFO history
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Encourages evidence-based interpretation of spectacular but natural events.</p>
        <div class="fr-book-actions">
