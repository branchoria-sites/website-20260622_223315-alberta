...
show_ads: true
description: The survey is useful for spotting report patterns, but its Nova Scotia entries are mostly low-detail night-light cases.
hero_summary: The survey is useful for spotting report patterns, but its Nova Scotia entries are mostly low-detail night-light cases.
layout: default
permalink: /survey-limits/
sidebar_expanded_urls:
- /what-really-happened-in-nova-scotias-ufo/
- /modern-reports/
nav_short_title: Survey Limits
title: What can UFO statistics really prove?
title_full: What can UFO statistics really prove?
display_title_short: Survey Limits
display_title: Survey Limits
heading_title: What can UFO statistics really prove?
page_heading_title: What can UFO statistics really prove?
source_count: 34
infographic_count: 3
planned_sections:
- Nocturnal lights and point source reports
- Unexplained versus insufficient information
- Why survey patterns need cautious reading
...
prev_link:
  ...
  heading_title: Do Facebook sightings make better UFO evidence?
header:
  og_image: /assets/images/Nova_Scotia_117534_modern_ns_ufo_report_4a2268_canadian_ufo_survey_934d55-Illustration-1-social.jpg
  preview_image: /assets/images/Nova_Scotia_117534_modern_ns_ufo_report_4a2268_canadian_ufo_survey_934d55-Illustration-1.webp
image: /assets/images/Nova_Scotia_117534_modern_ns_ufo_report_4a2268_canadian_ufo_survey_934d55-Illustration-1-social.jpg
---
...
The result is that many Nova Scotia entries in the survey are not rich investigative files. They are short reports describing lights, flashes, stars, satellites, [aircraft lights]({{ 'aircraft-lights/' | relative_url }}), drones, planets near the horizon, or objects that could not be confidently identified from the information available. A large collection of such reports can tell researchers what people are reporting, but not necessarily what they observed.

This is one reason why high report totals should be interpreted carefully. A province may produce many reports without producing many high-quality cases.
...
An unexplained case may simply mean:


<div class="content-enhancement content-enhancement--comparison" markdown="1">

* The witness supplied incomplete information.
* No corroborating evidence was available.
* Weather, astronomical and aviation checks were inconclusive.
* The available data did not support a confident identification.

</div>

In other words, "unexplained" means unresolved within the limits of the evidence. It does not establish that the object was extraordinary.

Likewise, a large number of insufficient-information cases does not prove that something mysterious is occurring. It often reflects the practical difficulty of investigating brief sightings after the fact.
...
Suppose two provinces experience the same number of unusual lights in the sky. If one province has active Facebook groups, local enthusiasts, media interest and clear reporting pathways, it may generate far more recorded cases. The difference appears in the database even if the underlying sky activity is identical.

The survey can therefore measure reporting behaviour as well as sighting behaviour.
...
The survey records these effects, but cannot fully separate them from any genuine increase in unusual observations.


<img src="{{ "/assets/images/Nova_Scotia_117534_modern_ns_ufo_report_4a2268_canadian_ufo_survey_934d55-Illustration-2-dark.svg" | relative_url }}" alt="Survey Limits illustration 2" data-theme-src-dark="{{ "/assets/images/Nova_Scotia_117534_modern_ns_ufo_report_4a2268_canadian_ufo_survey_934d55-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Nova_Scotia_117534_modern_ns_ufo_report_4a2268_canadian_ufo_survey_934d55-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What the survey can prove

Used correctly, the Canadian UFO Survey is a valuable source of evidence.
...
The survey has limits that are just as important as its strengths.

By itself, it cannot prove:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* That unexplained cases represent non-human technology.
* That Nova Scotia is a genuine physical hotspot for unusual aerial phenomena.
* That a rise in reports reflects a rise in unusual objects rather than a rise in reporting.
* That witnesses correctly interpreted what they saw.
* That all reports refer to separate events rather than duplicate accounts of the same sighting.
* That any single report occurred exactly as described.
...
The most useful way to read the Canadian UFO Survey is neither as proof of extraordinary events nor as evidence that all reports are mistakes.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains how sightings are documented, categorized, and assessed.</p>
        <div class="fr-book-actions">
