...
- New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_missing_official_fil_cfb4f4
tags:
- new-brunswick
- mc-leod-hill
- field-marks
...
show_ads: true
description: The reported holes or indentations matter most if ordinary farm causes can be separated from unusual physical effects.
hero_summary: The reported holes or indentations matter most if ordinary farm causes can be separated from unusual physical effects.
layout: default
permalink: /field-marks/
sidebar_expanded_urls:
- /what-really-happened-in-new-brunswick/
- /mc-leod-hill/
nav_short_title: Field marks
title: What could have made the Mc Leod Hill marks?
title_full: What could have made the Mc Leod Hill marks?
display_title_short: Field marks
display_title: Field marks
heading_title: What could have made the Mc Leod Hill marks?
page_heading_title: What could have made the Mc Leod Hill marks?
source_count: 33
infographic_count: 3
planned_sections:
- What was reportedly found in the field
- Farm machinery, animals, weather and other mundane possibilities
- Why missing measurements limit any conclusion
...
- basename: New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_missing_official_fil_cfb4f4
  title: Missing file | Mc Leod Hill
  permalink: /missing-file/
  short_title: Missing file
...
next_link:
  ...
  heading_title: Did later storytelling strengthen the sighting?
header:
  og_image: /assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-1-social.jpg
  preview_image: /assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-1.webp
image: /assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-1-social.jpg
---
...
The available reports also fail to answer basic questions that physical-trace investigators normally ask:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* How deep were the marks?
* Were they arranged in a geometric pattern?
* Did they affect soil, vegetation, or both?
* Were they photographed?
* How long did they remain visible?
* Did anyone inspect them independently?

</div>

Without answers to those questions, the marks remain an anecdotal observation rather than a documented physical trace.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/3f-D2zOLnko" title="Unexplained Phenomenons: Are They Alien Originated? | Crop Circles - Episode 1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=3f-D2zOLnko" target="_blank" rel="noopener noreferrer">Unexplained Phenomenons: Are They Alien Originated? | Crop Circles - Episode 1</a></p><p class="youtube-embed-meta">Channel: Signal Science</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=3f-D2zOLnko" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=3f-D2zOLnko">Open on YouTube</a></p></div></div></div>

## Farm machinery, animals, weather and other mundane possibilities

The strongest criticism of the [McLeod Hill trace]({{ 'mc-leod-hill/' | relative_url }}) claim is not that the marks were impossible to see, but that they were never documented well enough to eliminate ordinary explanations.
...
Large animals can create surprisingly regular depressions in soft ground. Repeated use of the same resting spots, feeding areas or paths can produce circular or oval marks. Because no measurements survive, there is no way to compare the reported marks with known livestock effects.

This does not prove an animal explanation, but it illustrates a broader problem: investigators cannot test alternatives when the physical dimensions are unknown.


<img src="{{ "/assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-2-dark.svg" | relative_url }}" alt="Field marks illustration 2" data-theme-src-dark="{{ "/assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Weather and ground conditions

Spring conditions in [New Brunswick]({{ 'what-really-happened-in-new-brunswick/' | relative_url }}) often involve thawing soil, moisture variations and freeze-thaw effects. Soft ground can develop depressions naturally, while wind and rain can alter vegetation patterns within hours or days.

If marks were discovered only after an unusual object was reported, witnesses may have connected unrelated ground features with the sighting. This is a common challenge in physical-trace cases, where timing alone can create an apparent relationship between two events.

### Human activity

Another possibility is simple human disturbance. Curious visitors arriving after rumours of a landing could unintentionally alter a site. By the time later observers inspected the field, they may have been looking at marks that had already been modified by foot traffic or other activity.

Because there is no documented chain of custody for the site, investigators cannot know what condition the field was in when the first marks were observed.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/KDqZvGJW4gk" title="Crop Circle Theorist Thinks the Truth is Out There" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=KDqZvGJW4gk" target="_blank" rel="noopener noreferrer">Crop Circle Theorist Thinks the Truth is Out There</a></p><p class="youtube-embed-meta">Channel: VICE</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=KDqZvGJW4gk" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=KDqZvGJW4gk">Open on YouTube</a></p></div></div></div>

## Why the reported marks do not strongly support an exotic explanation

Physical traces become significant when they display characteristics that are difficult to explain conventionally. Examples in stronger trace cases include documented burn patterns, laboratory-tested residues, measurable changes in vegetation, or detailed photographs taken shortly after discovery.

None of those elements are known from McLeod Hill.

The reported marks may have been genuine depressions in the field, but the surviving descriptions do not establish any unusual properties. There are no reports of:
...
The marks therefore tell us little about the nature of the object reportedly seen nearby. Even if the sighting occurred exactly as described, the field evidence does not independently confirm it.


<img src="{{ "/assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-3-dark.svg" | relative_url }}" alt="Field marks illustration 3" data-theme-src-dark="{{ "/assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/New_Brunswick_cd41a9_mcleod_hill_trace_cl_de2949_lint_farm_field_mark_962c0d-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why missing measurements limit any conclusion

The greatest weakness in the McLeod Hill trace claim is not scepticism; it is missing information.
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to What could have made the McLeod Hill marks?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explores reported UFO cases and the kinds of evidence investigators look for, including physical traces and witness testimony.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides a framework for evaluating extraordinary claims when physical evidence is limited or ambiguous.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers methods for assessing landing marks, ground traces, witness reports, and missing evidence.</p>
        <div class="fr-book-actions">
