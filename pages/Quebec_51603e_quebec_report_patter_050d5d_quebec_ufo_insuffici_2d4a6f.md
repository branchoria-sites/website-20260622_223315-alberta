...
show_ads: true
description: Many Quebec-style reports cannot be judged well because witnesses often describe brief night lights without enough direction, duration or comparison detail.
hero_summary: Many Quebec-style reports cannot be judged well because witnesses often describe brief night lights without enough direction, duration or comparison detail.
layout: default
permalink: /weak-data/
...
title: When UFO reports do not have enough detail
title_full: When UFO reports do not have enough detail
display_title_short: Weak Data
display_title: Weak Data
heading_title: When UFO reports do not have enough detail
page_heading_title: When UFO reports do not have enough detail
source_count: 38
infographic_count: 3
planned_sections:
- What insufficient information means in survey coding
- Why night light reports are hard to verify
- Details that separate useful reports from weak ones
...
prev_link:
  ...
  heading_title: Why city skies produce more UFO reports
header:
  og_image: /assets/images/Quebec_51603e_quebec_report_patter_050d5d_quebec_ufo_insuffici_2d4a6f-Illustration-1-social.jpg
  preview_image: /assets/images/Quebec_51603e_quebec_report_patter_050d5d_quebec_ufo_insuffici_2d4a6f-Illustration-1.webp
image: /assets/images/Quebec_51603e_quebec_report_patter_050d5d_quebec_ufo_insuffici_2d4a6f-Illustration-1-social.jpg
---
...
## The details investigators most need

The difference between a useful UFO report and a weak one is often surprisingly simple.

Researchers generally need enough information to reconstruct what happened and compare it with known aviation, astronomical, meteorological, or satellite activity. The most valuable details include:
...
## When a weak report should not be treated as an unexplained case
...
## What Quebec's weak-data pattern tells us
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for how researchers interpret reports and the evidential limitations of many sightings.</p>
        <div class="fr-book-actions">
